function Timer(id, endtime) {
	...
	this.weeksSpan = clock.querySelector('.weeks');  /* Alternatively, you could use document.getElementsByClassName('.weeks');*/
	this.daysSpan = clock.querySelector('.days');  /*If you were looking for an ID, you would write .querySelector('#days')*/
...
Timer.prototype.getTimeRemaining = function() {
	t = Date.parse(this.endtime) - Date.parse(new Date());
...
var endDate = new Date(Date.parse('August 9, 2017')); /*Converts date into a UNIX timestamp in milliseconds*/
